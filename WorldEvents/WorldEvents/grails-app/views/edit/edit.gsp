   ...
   <g:link class="headLabel" controller="display"><g:message code="label.title.events"/></g:link>
       ...
       <tr>
         <td width="2%"/>
       	...
       	<td>
       	  <g:if  test="${hasErrors(bean:event,field:'sDate','errors')}">
       	  	<g:textField id="datepicker" class="shorterrortext" name="sDate" pattern="${datePattern}" value="${fieldValue(bean:event,field:'sDate')}" />       
             <div  class="messageerror">
       		 <g:message  code="label.error.required"/>
       		 </div>
		  </g:if>
		  <g:else>
       		<g:textField id="datepicker" class="text" name="sDate" pattern="${datePattern}" value="${fieldValue(bean:event,field:'sDate')}" /> 
       	  </g:else>       
       	</td>
       </tr>
       <tr>
         ...
         <td>
      	 ...
      	 <td>
      	  <g:if  test="${hasErrors(bean:event,field:'eventtime','errors')}">
       	  	<g:textField id="timepicker" class="shorterrortext" name="eventtime" pattern="${timePattern}" value="${fieldValue(bean:event,field:'eventtime')}" />       
             <div  class="messageerror">
       		 <g:message  code="label.error.required"/>
       		 </div>
		  </g:if>
		  <g:else>
		    	<g:textField id="timepicker" class="text" name="eventtime" pattern="${timePattern}" value="${fieldValue(bean:event,field:'eventtime')}"/>
       	  </g:else>
      	 </td>
       </tr>
       <tr>
         <td width="2%"/>
       	...
       	<td>
       	 <g:if  test="${hasErrors(bean:event,field:'place','errors')}">
       	  	<g:textField id="timepicker" class="errortext" name="place" value="${fieldValue(bean:event,field:'place')}" />       
             <div  class="messageerror">
       		 <g:message  code="label.error.required"/>
       		 </div>
		  </g:if>
		  <g:else>
       	   <g:textArea class="textlarge" name="place" value="${event?.place}"/>
       	  </g:else>
       	</td>
       </tr>
       <tr>      
