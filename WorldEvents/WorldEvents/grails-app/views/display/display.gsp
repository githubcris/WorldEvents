...
<div class="divCenterClass">
  ...
  <p class="separator"></p>
       ...
       <p class = "leftAlign" style="list-style: none outside none;">   
            <label  for="eventnamelable" class="label" ><g:message code="label.field.date"/>:</label>
              <%java.text.SimpleDateFormat dateFormat = new java.text.SimpleDateFormat("dd/MM/yyyy");
				String sDate = dateFormat.format(new Date().parse("yyyy-MM-dd", event.eventdate?.toString()))%>
           <label class="label"  id="${event.eventdate}">${sDate}</label>         
       </p>
       <p class = "leftAlign" style="list-style: none outside none;">   
     	    <label  for="eventnamelable" class="label" ><g:message code="label.field.time"/>:</label>
            <label class="label" id="${event.eventtime}">${event.eventtime?.encodeAsHTML()}</label>
    ...
    <g:paginate  controller="display" action="searchResults" params="${[dateIni:dateIni, dateLast: dateLast]}" offset="${offset}" total="${results.totalCount}" max="${max}"  />
    </div>
    </g:else>
	</g:if>
    <g:else>
